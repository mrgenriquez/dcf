...
<?php
	...
	<div class="entry-thumb">
		<?php namm_organic_template_part( 'blog', 'templates/post-format/post', $post_format, $template_args ); ?>
        <?php do_action( 'namm_organic_blog_archive_post_format', $enable_post_format, $post_format ); ?>
	</div><!-- Featured Image -->