...
if( !class_exists( 'NammOrganic_Woo_Listing_Shop' ) ) {

    class NammOrganic_Woo_Listing_Shop {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'namm_organic_woo_shop_page_default_settings', $this->settings );
...
if( !function_exists('namm_organic_woo_listing_shop') ) {
	function namm_organic_woo_listing_shop() {
		return NammOrganic_Woo_Listing_Shop::instance();
	}
}

namm_organic_woo_listing_shop();