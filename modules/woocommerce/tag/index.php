...
if( !class_exists( 'NammOrganic_Woo_Listing_Tag' ) ) {

    class NammOrganic_Woo_Listing_Tag {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'namm_organic_woo_tag_page_default_settings', $this->settings );
...
if( !function_exists('namm_organic_woo_listing_tag') ) {
	function namm_organic_woo_listing_tag() {
		return NammOrganic_Woo_Listing_Tag::instance();
	}
}

namm_organic_woo_listing_tag();