...
if( !class_exists( 'NammOrganic_Woo_Listing_Option_Thumb_Content' ) ) {

    class NammOrganic_Woo_Listing_Option_Thumb_Content extends NammOrganic_Woo_Listing_Option_Core {
        ...
        function __construct() {
            ...
            $this->option_name          = esc_html__('Thumb Content', 'namm-organic');
        ...
        */
            ...
            function render_backend() {
                add_filter( 'namm_organic_woo_custom_product_template_thumb_options', array( $this, 'woo_custom_product_template_thumb_options'), 10, 1 );
            }
...
if( !function_exists('namm_organic_woo_listing_option_thumb_content') ) {
	function namm_organic_woo_listing_option_thumb_content() {
		return NammOrganic_Woo_Listing_Option_Thumb_Content::instance();
	}
}

namm_organic_woo_listing_option_thumb_content();