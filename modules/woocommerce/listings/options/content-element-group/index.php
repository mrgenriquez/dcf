...
if( !class_exists( 'NammOrganic_Woo_Listing_Option_Content_Element_Group' ) ) {

    class NammOrganic_Woo_Listing_Option_Content_Element_Group extends NammOrganic_Woo_Listing_Option_Core {
        ...
        function render_backend() {
            ...
            add_filter( 'namm_organic_woo_custom_product_template_content_options', array( $this, 'woo_custom_product_template_content_options'), 50, 1 );
        }
...
if( !function_exists('namm_organic_woo_listing_option_content_element_group') ) {
	function namm_organic_woo_listing_option_content_element_group() {
		return NammOrganic_Woo_Listing_Option_Content_Element_Group::instance();
	}
}

namm_organic_woo_listing_option_content_element_group();