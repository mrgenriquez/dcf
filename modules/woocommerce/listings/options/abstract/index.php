...
abstract class NammOrganic_Woo_Listing_Option_Core {
    ...
    */
        ...
        function module_dir_path() {
            ...
            if( namm_organic_is_file_in_theme( __FILE__ ) ) {
                return NAMM_ORGANIC_MODULE_DIR . '/woocommerce/listings/options/';
            } else {
        ...
        function module_dir_url() {
            ...
            if( namm_organic_is_file_in_theme( __FILE__ ) ) {
                return NAMM_ORGANIC_MODULE_URI . '/woocommerce/listings/options/';
            } else {
     ...
     */
        function render_frontend() {
            ...
            /* Options Class Names */
                add_filter( 'namm_organic_woo_listings_class', array( $this, 'woo_listings_class_load'), 10, 1 );
            ...
            if( $non_archive_listing ) {
                ...
                /* Options JS */
                    add_filter( 'namm_organic_woo_non_archive_js', array( $this, 'woo_listings_js_load'), 10, 1 );
                ...
                /* Options JS */
                    add_filter( 'namm_organic_woo_archive_js', array( $this, 'woo_listings_js_load'), 10, 1 );
            }
        ...
        function woo_listings_loop_prop() {
            ...
            if( in_array( 'html', $this->option_type ) ) {
                if( !empty ( $this->option_default_value ) ) {
                    ...
                    array_push( $namm_organic_shop_loop_prop, $this->option_slug );
                    wc_set_loop_prop('wdt-shop-loop-prop', $namm_organic_shop_loop_prop);
...
if( !function_exists('namm_organic_woo_listing_option_core') ) {
	function namm_organic_woo_listing_option_core() {
		return NammOrganic_Woo_Listing_Option_Core::instance();
	}
}