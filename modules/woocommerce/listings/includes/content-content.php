...
if( ! function_exists( 'namm_organic_shop_woo_loop_product_content' ) ) {

	function namm_organic_shop_woo_loop_product_content() {
		...
		if($product_content_enable) {
			...
			if($product_content_content) {
				...
				namm_organic_shop_woo_loop_product_content_content_setup($product_content_content);
				...
				echo '<div class="product-details">';
					...
					// Others
					do_action('namm_organic_woo_loop_product_content_content', 'content');
					remove_all_actions('namm_organic_woo_loop_product_content_content');
				echo '</div>';
	...
	add_action( 'woocommerce_shop_loop_item_title', 'namm_organic_shop_woo_loop_product_content', 10 );
