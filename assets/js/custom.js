...
(function($) {
    ...
    $('body').on('input', '.text_input', function() {
        var thisItem = $(this);
        var searchVal = $.trim(thisItem.val());
        var results = thisItem.siblings('.quick_search_results');
        ...
        searchTimer = setTimeout(function() {
            searchRequest = $.ajax({
                type: 'POST',
                url: namm_organic_urls.ajaxurl,
                data: {
                    action: 'namm_organic_search_data_fetch',
                    search_val: searchVal,
                    nonce: namm_organic_urls.search_nonce
                },
